...
| --- | --- | --- | --- | --- | --- | --- |
| `feat/m1-transport` | 2026-08-08 | _진행 중_ | — | (진행) | **M1-1 net 골격** — ADR-0003 Transport 경계(`Transport`/`Link`/`PeerHint`/`DiscoveryEvent`)·`InMemoryTransport` fake(소켓 없이 발견·연결·이탈 테스트)·core `DisplayName`(RLO 무해화 FR-S-13) | [journal/2026-08-08](journal/2026-08-08.md) |
