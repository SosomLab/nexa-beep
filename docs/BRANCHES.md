...
| --- | --- | --- | --- | --- | --- | --- |
| `feat/m0-scaffold` | 2026-08-08 | _진행 중_ | — | 2 | **M0 기반** — M0-1 워크스페이스 스캐폴딩(9크레이트)·M0-1b 횡단 골격(ActionKind 단일 통로·인터셉터 파이프라인·포트). 이어 M0-1c·M0-3 | [journal/2026-08-08](journal/2026-08-08.md) |
