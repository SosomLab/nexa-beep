...
| --- | --- | --- | --- | --- | --- | --- |
| `feat/m2-session` | 2026-08-08 | _진행 중_ | — | (진행) | **M2-1 세션** — a) `Link` core 이관·`Session` 트레이트·`PlainSession` 스텁·`duplex` fake  b) **실물 `NoiseSession`(snow · Noise_XX)**·`Identity`(X25519=PeerId)·평문 미노출 검증. snow 라이선스 퍼미시브 | [journal/2026-08-08](journal/2026-08-08.md) |
