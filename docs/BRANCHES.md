...
| --- | --- | --- | --- | --- | --- | --- |
| `feat/m1-localdirect` | 2026-08-08 | _진행 중_ | — | 2 | **M1-4 슬라이스 2·3** — `TcpLink`·`LocalDirect`(발견+TCP를 Transport로) · **실물 종단 왕복**(맥 2프로세스·Docker 2노드) · GUI `--live` 배선(`Box<dyn Transport>` 한 지점 교체) | [journal/2026-08-08](journal/2026-08-08.md) |
