...
| --- | --- | --- | --- | --- | --- | --- |
| `feat/m0-scaffold` | 2026-08-08 | _진행 중_ | — | (진행) | **M0-1 스캐폴딩** — Cargo 워크스페이스·9크레이트·rust-toolchain·release 프로파일. 이어 M0-1b 횡단 골격 | [journal/2026-08-08](journal/2026-08-08.md) |
