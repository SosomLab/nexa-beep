...
| --- | --- | --- | --- | --- | --- | --- |
| `feat/m2-session` | 2026-08-08 | _진행 중_ | — | (진행) | **M2-1a 세션 추상화** — `Link` core 이관(crypto가 net 몰라도 되게)·`Session` 트레이트·`PlainSession` 스텁(암호 없이 상위 검증)·core `duplex` 링크 fake | [journal/2026-08-08](journal/2026-08-08.md) |
