...
| --- | --- | --- | --- | --- | --- | --- |
| `feat/m3-inmem-e2e` | 2026-08-08 | _진행 중_ | — | 2 | **InMemory 종단 데모**(실물 발견→Noise→TOFU→다중화→대화 왕복 — M2 게이트 GUI 실증) · **DR-26**(대화 상태-뷰 분리 즉시 반영·창 모드 설정 옵션·[14 §11]) | [journal/2026-08-08](journal/2026-08-08.md) |
