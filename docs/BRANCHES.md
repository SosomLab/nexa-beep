...
| --- | --- | --- | --- | --- | --- | --- |
| `feat/m3-multiwin` | 2026-08-08 | _진행 중_ | — | 1 | **M3-12 다중 대화 창** — `WinEntry` 창 단위 라우팅·Separate/Single 모드·재활성화=포커스·창 닫기=뷰만(DR-26 분리 회수 — 도메인 변경 0) | [journal/2026-08-08](journal/2026-08-08.md) |
