...
| --- | --- | --- | --- | --- | --- | --- |
| `feat/m3-fontmap` | 2026-08-08 | _진행 중_ | — | 1 | **폰트 메모리 매핑(R-15)** — memmap2 채택(사용자 확정)·`Box::leak` 프로세스 수명·gfx `FontRef<'static>` 전환·**RSS −51MB 실측**·plat→gfx 의존 제거 | [journal/2026-08-08](journal/2026-08-08.md) |
