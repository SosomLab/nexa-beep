...
| --- | --- | --- | --- | --- | --- | --- |
| `feat/m0-scaffold` | 2026-08-08 | _진행 중_ | — | 4 | **M0 기반** — M0-1 스캐폴딩(9크레이트)·M0-1b 횡단 골격(ActionKind·파이프라인·포트)·테스트 더블 명문화·M0-1c 안정 코드+마스킹. 이어 M0-3 CI | [journal/2026-08-08](journal/2026-08-08.md) |
