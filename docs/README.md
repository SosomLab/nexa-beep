...
| [19 ADR-0006 수동 엔드포인트 등록](19-adr-0006-manual-endpoint.md) | ✅ **Accepted**(08-08 — `add_endpoint` 구현·맥↔docker IP 실증) — 직접 IP/DDNS 노드 추가 · 인바운드 요청 대기 · 릴레이와의 경계 · ★ **§5-1 경로 이동과 신원 연속성**(DR-28 — 신뢰 2축 분리 · 경로 등급은 성립한 세션이 정한다 · 경로 수명 R-20) |
