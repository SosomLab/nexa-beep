...
| [08 ADR-0002 디스커버리·전송·암호](08-adr-0002-discovery-transport.md) | 📐 **Proposed** — 자체 컴팩트 UDP · TCP 세션 · **Noise_XX + TOFU** · 발견은 "미검증 힌트" |
...
| **08** | **ADR-0002 디스커버리/전송/암호** | 📐 Proposed |
| 09 | **ADR-0003 전송 추상화** | 예약 |
| **10** | 결정 기록(DR·ADR 색인) | ✅ |
