...
| [24 ADR-0010 메시지 등급·알림·수신확인](24-adr-0010-message-priority-notification.md) | 📐 **Proposed** — 등급 3종은 **발신자의 요청**·강도는 **수신자 판정**(신뢰 게이트) · 미리보기 규칙 · **수동 수신확인**("읽음" 없음) · **대체 알림은 수신자가 자기 채널로 · 외부에도 봉투만** · Webhook 우선 |
...
| **24** | **ADR-0010 메시지 등급·알림·수신확인·대체 채널** | 📐 Proposed |
