...
5. **핵심 결정** — [10 결정 기록](10-decision-record.md) : **DR-1~28** + **ADR 11종** 색인
...
| [05 요구사항](05-requirements.md) | ★ **FR 119건** · NFR 29건(**B 예산 게이트**) · 제약 C-1~6 · **리스크 R-1~21**(해소 = R-12·R-15·R-17·R-19·R-21) |
| [10 결정 기록](10-decision-record.md) | ★ **DR-1~28** · **ADR 11종 색인** · 의존성/차용자산 원장 |
...
| [11 ADR-0004 수신 무해화](11-adr-0004-quarantine.md) | 📐 **Proposed — 확정 대기(D-12)** · ⚠️ **구현은 이미 도메인 전 구간 완료**(M4-1) — `.beepq` 레이아웃 · 위험 등급 4단계 확장자표 · 상태 기계(fail-closed) · MotW/quarantine API |
...
| **35** | **ADR-0014 파일 선택은 시스템 기본 다이얼로그로** — DR-6 경계 획정 · `FileDialogPort` · Win/mac 직접 어댑터 권고 | 📐 Proposed(🔴 D-30) |
