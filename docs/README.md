...
1. **왜 만드나** — [00 비전](00-vision.md) _(작성 예정)_
...
4. **무엇을 만드나** — [05 요구사항](05-requirements.md) _(작성 예정)_
5. **핵심 결정** — [10 결정 기록](10-decision-record.md) : DR-1~13 + ADR 색인
6. **어떻게 짓나** — [01 아키텍처](01-architecture.md) → [02 로드맵](02-roadmap.md) _(작성 예정)_
...
| 문서 | 내용 |
|---|---|
| [00 비전](00-vision.md) | 왜 만드나·차별화·성공 기준 — _작성 예정_ |
...
| [05 요구사항](05-requirements.md) | FR/NFR/제약/리스크 — _작성 예정_ |
| [10 결정 기록](10-decision-record.md) | ★ DR-1~12 · ADR 색인 · 의존성/차용자산 원장 |
...
| 문서 | 내용 |
|---|---|
| [01 아키텍처](01-architecture.md) | 모듈 구조·디스커버리·전송·스레딩 — _작성 예정_ |
| [02 로드맵](02-roadmap.md) | 단계별 계획 — _작성 예정_ |
...
| 번호 | 문서 | 상태 |
|---|---|---|
| 00 · 01 · 02 | 비전 · 아키텍처 · 로드맵 | 예약 |
| **03 · 04** | 경쟁 조사 · 안전 송수신 | ✅ |
| 05 | 요구사항 | 예약 |
| **06** | 네트워크 스택 L1~L4 | ✅ |
| 07 · 08 · 09 | **ADR-0001 스택** · **ADR-0002 디스커버리/전송** · **ADR-0003 전송 추상화** | 예약 |
| **10** | 결정 기록(DR·ADR 색인) | ✅ |
