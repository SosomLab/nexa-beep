...
| M3-3 | **IME 완성**(FR-U-7 한/중/일) · 고DPI 배율(FR-U-6) · 다크/라이트(FR-U-5) | P0 | 대 | M3-1d | 🚧 (08-08 — 배율(M1-6)·조합 프리에딧(대화 입력 밑줄 표시·확정 경로) 완료 · edit 모델 char 단위. 잔여 = 조합 중 캐럿 세부·중일 검증·다크/라이트 토글은 설정) |
