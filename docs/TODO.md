...
| M4-2 | 파일 **드래그앤드롭** · **폴더 전송**(FR-X-1/2 구조 유지) · **스트리밍**·진행률·취소(FR-X-4/5) · 협상→수락→전송(FR-X-3) · SHA-256 검증(FR-X-6) | P0 | 대 | M4-1 | 🚧 (08-09 — **정책·UX 완성**: 와이어·수신 조립기 · CLI/GUI 전송 · **전송 자격**(핀+양방향 대화 1회) · **승인 4방식**(자동/기간/수동/거부 · 오퍼당 1승인) · **수신 승인 화면**(정보 4종·즉석 자동승인·타임아웃) · **다중 파일 큐** · **진행률**(목록 막대·대화창·CLI) · **대역폭 제어**(자동 50%·쌍방 협상 · 실측 19.9s/이론 20.0s) · TimeoutButton. 잔여 = **수락 후 취소 UX**·폴더 전송·재개·드롭 발신 육안 검증) |
