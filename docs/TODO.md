...
| **M5-1g** | **공유 그룹 채팅 G1~G4**([31 ADR-0012](31-adr-0012-shared-group-chat.md) — 한 방 대화·발신자 라벨·roster 서명·초대 수락·구성원 관리 모달·재동기) · ⚠️ **[32 §8 P-9·P-10·P-11](32-adr-0013-server-modes.md) 선행 제약을 함께 지킨다**(콘텐츠 키 봉투 수용 포맷 · 중복 제거 키 고정 · roster 정책 필드 자리) — 나중에 넣으면 **와이어·서명 포맷 변경** | P0 | 대 | 🔴 D-28 | ☐ (설계 완료 — 확정 대기) |
