...
| M1-8x | **정상 종료 경로**(FR-P-7 · R-16 · [19?]) — `plat::shutdown`(SIGINT/SIGTERM 포트·DR-21) + 헤드리스 루프 깨우기. ✅ 08-08 핵심(docker stop 10.26→0.38s). 잔여 = GUI 종료 훅·zeroize·Windows 콘솔 핸들러 | P0 | 소 | — | 🚧 |
