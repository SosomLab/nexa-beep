...
| **배포** | **v0.2.15** — Windows(x64·ARM64) · macOS(x64·ARM64) · Linux(x64) **5타깃 × 2채널**(설치본·포터블 · 자산 14종) · **Homebrew** 자동 추종 · winget·Chocolatey는 **검수 중**(winget v0.2.14 PR #427125/#427126 수동 리뷰 · **choco = 검수자 Requirement 1건(`iconUrl` jsDelivr) 09-05 수정 · 재제출 대기** · 통과 전 새 버전 제출 보류 = 0.2.15 제외) · 서버 `nexa-beepd`는 **`beepd-v*` 별도 릴리스**(Linux = musl 정적) · 태그 push = 자동 → [Releases](https://github.com/SosomLab/nexa-beep/releases) |
