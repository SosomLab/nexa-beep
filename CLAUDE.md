...
- 현 단계: **설계 문서 31종(00~30) · ADR 11종 · DR-1~28 · FR 119건+ · 리스크 R-1~21.** 코드는 **M0 기반 🚧(크기 축 ✅·RSS 실기 잔여) → M1 발견 🚧(S1~S3 실물·와이어 확정 · ★R-21 ✅=M1-4b · ★R-19 ✅=M1-10 표시 이름 정제) → M2 대화 🚧(실물 Noise·M2-8 연결 워커 ✅ · ★**M2-5a 신원·핀 영속 ✅ = R-17 해소**(D-18 §3 확정 · 백업/복원 핫 로딩) · 잔여 M2-4b·M2-5b) → M3 셸·UI 🚧(말풍선 대화 화면 · 커스텀 컨트롤 **17종**(+Switch iOS 스타일·크기 배율 옵션) · **★M3-15 설정 영속 ✅**(D-25 · `crates/nexa-conf`) · **M3-17 프로필 화면부 ✅**(공개 토글·백업/복원 — 잔여 = 교환 와이어) · 설정 desc 워드랩) → M4 전송·무해화 🚧(파일 송수신 ✅ · ★M4-9 종단 ack ✅ · **Win MotW ✅**(M4-3 일부) · M4-10 전송 동기·재개 설계 대기) → M5 배포(★**v0.1.3 공개**(08-11 — M5-4d 더블클릭 수정 실림) · M5-4b = choco/winget 변수만(보류 중))**(08-11 · **465테스트 green**).
