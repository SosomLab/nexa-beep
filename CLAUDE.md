...
## 5. 다음 단계 (2026-08-12 · STATUS 08-12 3차 기준)
...
4. ⏸ **실기 필요(대행 불가)** — D-8b 실망 타이밍 실측(**실기 2대 같은 망**) · SP-1b/d/e · **mac 유휴 RSS 재실측**(85.7MB vs 30MB — R-8 잔여 축. ★ **Windows는 08-12 관측 17.1MB로 예산 안쪽**이라 초과는 mac 축 문제일 가능성이 크다) · M4-3b 실소켓 캡처(W-8) · 2-PC 실기(핀 유지·rename 전파·프로필 왕복·전송 ack 왕복).
